...
class AppleMusicApi(object):
    ...
    def _get(self, url: str, params=None, storefront=None, language=None):
        ...
        if r.status_code not in [200, 201, 202]:
            print(f"Unexpected status code: {status_code}")  # Print the status code
    ...
    def get_album_cover(self, album_id):
        try:
            ...
            if album_details:
                album_artwork_url = album_details['attributes']['artwork']['url']
                return album_artwork_url
            else:
                print("Album not found on Apple Music.")
                return None
